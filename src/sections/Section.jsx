            ...
            <div key={index} className="p-2 sm:w-1/2 w-full">
              <div className="bg-gray-800 rounded flex p-4 h-full items-center">
                ...
                <span className="title-font font-medium text-white">
                  {index === 0 && "Authentic Cliche Forage"}
                  {index === 1 && "Kinfolk Chips Snackwave"}
                  {index === 2 && "Coloring Book Ethical"}
                  {index === 3 && "Typewriter Polaroid Cray"}
                  {index === 4 && "Pack Truffaut Blue"}
                  {index === 5 && "The Catcher In The Rye"}
                </span>
              </div>
            </div>
          ))}
